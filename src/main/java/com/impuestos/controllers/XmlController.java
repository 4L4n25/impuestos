...
public class XmlController {
	...
	@GetMapping("/files")
	public ResponseEntity<List<FileXml>> getAllFiles() throws Exception{
		List<FileXml> files = xmlFileService.loadAll().map(path->{
			...
			return new FileXml(filename,url);
